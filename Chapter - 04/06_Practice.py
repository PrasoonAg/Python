...
print(dict1.items(),"\n")
#=========================================================================#
#Q2# You are given a list of subjects for students. Assume one classroom is required for 1 subjets.
...
#Q3# WAP to enter marks of 3 subjects from the user and store them in a dictionary.
   # Start with an empty dicitionary & add one by one. Use subject name as key & marks as value.
...
print(value3,"\n")
# Both tuples are kept because the first element ("float"/"int") is different, making the tuples unique.
#=========================================================================#