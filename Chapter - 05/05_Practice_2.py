# 05
#=========================================================================#
# Practice Questions - 2 (based on for loop)
#=========================================================================#
...
# Linear Search in Python (or in general) is a simple searching technique used
# to find a particular element in a list (or any sequence) by checking each element one by
# one until the target is found or the list ends.
